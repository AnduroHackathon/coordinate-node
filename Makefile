...
am__aclocal_m4_deps = $(top_srcdir)/build-aux/m4/ax_boost_base.m4 \
	...
	$(top_srcdir)/build-aux/m4/coordinate_qt.m4 \
...
CONFIG_CLEAN_VPATH_FILES = contrib/devtools/iwyu/bitcoin.core.imp \
	contrib/filter-lcov.py test/functional/test_runner.py \
...
ACLOCAL = ${SHELL} '/home/qrsnap/git/coordinate-sidechain-node-closed-beta/build-aux/missing' aclocal-1.16
AMTAR = $${TAR-tar}
...
ARM_SHANI_CXXFLAGS = 
AS = as
AUTOCONF = ${SHELL} '/home/qrsnap/git/coordinate-sidechain-node-closed-beta/build-aux/missing' autoconf
AUTOHEADER = ${SHELL} '/home/qrsnap/git/coordinate-sidechain-node-closed-beta/build-aux/missing' autoheader
AUTOMAKE = ${SHELL} '/home/qrsnap/git/coordinate-sidechain-node-closed-beta/build-aux/missing' automake-1.16
...
BITCOIN_DAEMON_NAME = coordinated
BITCOIN_GUI_NAME = coordinate-qt
...
COORDINATE_CLI_NAME = coordinate-cli
COORDINATE_TX_NAME = coordinate-tx
COORDINATE_UTIL_NAME = coordinate-util
COORDINATE_WALLET_TOOL_NAME = coordinate-wallet
...
LUPDATE = 
MAINT = 
MAKEINFO = ${SHELL} '/home/qrsnap/git/coordinate-sidechain-node-closed-beta/build-aux/missing' makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
MINIUPNPC_LIBS = 
...
PACKAGE_STRING = Bitcoin Core 26.0.0
...
ZMQ_LIBS = -lzmq
abs_builddir = /home/qrsnap/git/coordinate-sidechain-node-closed-beta
abs_srcdir = /home/qrsnap/git/coordinate-sidechain-node-closed-beta
abs_top_builddir = /home/qrsnap/git/coordinate-sidechain-node-closed-beta
abs_top_srcdir = /home/qrsnap/git/coordinate-sidechain-node-closed-beta
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/qrsnap/git/coordinate-sidechain-node-closed-beta/build-aux/install-sh
...
COORDINATED_BIN = $(top_builddir)/src/$(BITCOIN_DAEMON_NAME)$(EXEEXT)
COORDINATE_QT_BIN = $(top_builddir)/src/qt/$(BITCOIN_GUI_NAME)$(EXEEXT)
BITCOIN_TEST_BIN = $(top_builddir)/src/test/$(BITCOIN_TEST_NAME)$(EXEEXT)
COORDINATE_CLI_BIN = $(top_builddir)/src/$(COORDINATE_CLI_NAME)$(EXEEXT)
COORDINATE_TX_BIN = $(top_builddir)/src/$(COORDINATE_TX_NAME)$(EXEEXT)
COORDINATE_UTIL_BIN = $(top_builddir)/src/$(COORDINATE_UTIL_NAME)$(EXEEXT)
COORDINATE_WALLET_BIN = $(top_builddir)/src/$(COORDINATE_WALLET_TOOL_NAME)$(EXEEXT)
...
#  $(OSX_APP)/Contents/MacOS/Coordinate-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
EXTRA_DIST = $(DIST_SHARE) $(DIST_CONTRIB) $(WINDOWS_PACKAGING) \
	...
	test/util/data/coordinate-util-test.json \
...
#	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM) $(COORDINATED_BIN) $(top_builddir)/release
#	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM) $(COORDINATE_QT_BIN) $(top_builddir)/release
#	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM) $(BITCOIN_TEST_BIN) $(top_builddir)/release
#	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM) $(COORDINATE_CLI_BIN) $(top_builddir)/release
#	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM) $(COORDINATE_TX_BIN) $(top_builddir)/release
#	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM) $(COORDINATE_WALLET_BIN) $(top_builddir)/release
#	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM) $(COORDINATE_UTIL_BIN) $(top_builddir)/release
...
#$(OSX_APP)/Contents/MacOS/Coordinate-Qt: all-recursive
#	$(MKDIR_P) $(@D)
#	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM)  $(COORDINATE_QT_BIN) $@
...
#$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Coordinate-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
#	INSTALL_NAME_TOOL=$(INSTALL_NAME_TOOL) OTOOL=$(OTOOL) STRIP=$(STRIP) $(PYTHON) $(OSX_DEPLOY_SCRIPT) $(OSX_APP) $(OSX_VOLNAME) -translations-dir=$(QT_TRANSLATION_DIR)

#deploydir: $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Coordinate-Qt

#deploy: $(OSX_ZIP)

$(COORDINATE_QT_BIN): FORCE
	$(MAKE) -C src qt/$(@F)

$(COORDINATED_BIN): FORCE
	$(MAKE) -C src $(@F)

$(COORDINATE_CLI_BIN): FORCE
	$(MAKE) -C src $(@F)

$(COORDINATE_TX_BIN): FORCE
	$(MAKE) -C src $(@F)

$(COORDINATE_UTIL_BIN): FORCE
	$(MAKE) -C src $(@F)

$(COORDINATE_WALLET_BIN): FORCE
	$(MAKE) -C src $(@F)
